...
<div id="tao-tracnghiem">
	<div class="container">
		<div class="row">
			<div class="span3" >
                <div id="column-cauhoi" class="column-fixed">
			...
			<div class="span6" id="column-noidung" >
				...
				<div class="noidung including">
					<div>
						<p>Nội dung</p>
						<textarea name="noi-dung-cau-hoi" id="editor1" class="ckeditors" >Tungf</textarea>
					</div>
			...
			<div class="span3">
                <div class="column-fixed" id="column-dapan">
...
<script type="text/javascript">
    ...
    var element=".column-fixed";
    function changSizeFixed(){
        if(width>768){
           if(scrollTop>=500){
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        function updateEditorValue(){
            var noi_dung=CKEDITOR.instances['editor1'].getData();
            cau_hoi[cau_selected.attr("dir")].noi_dung=noi_dung;

            var cau_a=CKEDITOR.instances['editor2'].getData();
            cau_hoi[cau_selected.attr("dir")].cau_a=cau_a;

            var cau_b=CKEDITOR.instances['editor3'].getData();
            cau_hoi[cau_selected.attr("dir")].cau_b=cau_b;

            var cau_c=CKEDITOR.instances['editor4'].getData();
            cau_hoi[cau_selected.attr("dir")].cau_c=cau_c;

            var cau_d=CKEDITOR.instances['editor5'].getData();
            cau_hoi[cau_selected.attr("dir")].cau_d=cau_d;
        }
        function changeEditorValue(){
            CKEDITOR.instances['editor1'].setData(cau_hoi[cau_selected.attr("dir")].noi_dung);
            CKEDITOR.instances['editor2'].setData(cau_hoi[cau_selected.attr("dir")].cau_a);
            CKEDITOR.instances['editor3'].setData(cau_hoi[cau_selected.attr("dir")].cau_b);
            CKEDITOR.instances['editor4'].setData(cau_hoi[cau_selected.attr("dir")].cau_c);
            CKEDITOR.instances['editor5'].setData(cau_hoi[cau_selected.attr("dir")].cau_d);
        ...
        function changeSelected(object){
            ...
            cau_selected=object;
            window.location.href=location.pathname+"#column-noidung";
        }
                ...
                $.ajax({
                    ...
                    success:function(data){
                        var html="<div class='text-center'><h3>Đã tạo chủ đề: "+chu_de+"</h3>"+
                                ...
                                "</div>";
                        $("#thongtin-tracnghiem .container").prepend(html);       
